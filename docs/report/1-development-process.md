...
- redazione del *product backlog*, ossia l'elenco di attività da svolgere nell'ambito del progetto, completo di livello di priorità, stima della durata e assegnatario per ciascuna attività;
...
Le attività di progetto sono state suddivise in iterazioni (*dette sprint*), prevalentemente della durata di una settimana. In totale, sono stati pianificati 7 sprint.
